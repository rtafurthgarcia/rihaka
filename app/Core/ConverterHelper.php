...
class ConverterHelper {
    ...
    /**
    * Converts a UML log file generated by Cowrie to a json that is readable by the asciinema player. 
    * @param string $filePath: file leading to the UML file thats been uploaded
    * @return string: path to the new json thats been generated.
    */

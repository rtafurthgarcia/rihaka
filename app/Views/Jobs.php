<section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="display-5 fw-bold">Jobs</h1>
        <p class="lead text-muted">Are you looking for a responsible and independent job in one of the best IT companies? Do you want to be involved in exciting projects using the latest technologies? Do you want to be part of a dynamic team that makes the extraordinary possible? Then maybe you are the right person for us.</p>
  ...
  <div class="container px-4 py-5" id="featured-3">
    <h2 class="pb-2 border-bottom">Job vacancies</h2>

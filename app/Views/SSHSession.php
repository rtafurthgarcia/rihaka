        ...
        <div class="signup-form col-12 col-md-8 col-lg-5 px-4 py-4 py-md-0">
            <? if((isset($successful) && $successful)): ?>
                <div class="alert alert-success" role="alert">
                    ...
                    New session successfully created :3
                </div>
            <? else: ?>
            <h2 class="fs-3 fw-semibold btn btn-lg btn-toggle d-inline-flex align-items-center rounded border-0 ps-0">Upload new content</h2>
            <p>Just make sure to upload interesting non-boring and bland stuff</p>
